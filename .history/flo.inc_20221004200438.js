...
const API = {
    ...
    URI: {
        ...
        TID: {
            AUTHORIZE: `https://${FLO.TID.HOST}.skt-id.co.kr/auth/authorize.do`,
            SIGNOUT: `https://${FLO.TID.HOST}.skt-id.co.kr/sso/web/v1/ssologout.do`,
            REDIRECT_URI: `${FLO.LOCATION.URL}/tid`,
        },
        PURCHASE: {
